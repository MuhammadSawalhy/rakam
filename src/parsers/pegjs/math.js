...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c14 = function(num, name, args) {
            if (name) {
      ...
      peg$c16 = function(value) { return new Node('number' , [], { value }); },
      peg$c17 = function(name) { return new Node('variable' , [], { name }); },
      peg$c18 = ",",
      ...
      peg$c26 = function(sign, num) { return parseFloat(text().replace(/\ /g, '')); },
      peg$c27 = ".",
      peg$c28 = peg$literalExpectation(".", false),
      peg$c29 = /^[eE]/,
      peg$c30 = peg$classExpectation(["e", "E"], false, false),
      peg$c31 = peg$otherExpectation("name"),
      peg$c32 = /^[a-zA-Z_]/,
